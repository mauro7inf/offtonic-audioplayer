class Component {
  ...
  createPropertyValue(descriptor, value) {
    if (value !== null && typeof value === 'object' && 'className' in value) {
      return this.constructor.o.createComponent(value, this.player, this.registry, this.tuning);
    } else if (descriptor.isAudioComponent && value !== null && typeof value === 'number') {
      return this.constructor.o.createComponent({
      ...
      for (let i = 0; i < value.length; i++) {
        if (value[i] !== null && typeof value[i] === 'object' && 'className' in value[i]) {
          ...
          createdArray.push(this.constructor.o.createComponent({
            className: 'Note',
            tuningName: this.tuning.getTuningName(),
            note: value[i]
          }, this.player, this.registry, this.tuning));
