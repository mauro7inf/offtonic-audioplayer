...
class Tone extends Playable {
  ...
  setEnvelope(envelope) {
    super.genericSetter('envelope', envelope);
    if (this.envelope !== null && typeof this.envelope === 'object' && this.envelope.isEnvelope) {
      this.envelope.playable = this;
    }
  }

  release() {
    if (this.envelope !== null && typeof this.envelope === 'object' && this.envelope.isEnvelope) {
      this.envelope.startRelease();
    } else {
      this.stop();
    }
  }
