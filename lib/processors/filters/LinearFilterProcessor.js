class LinearFilterProcessor extends OfftonicAudioplayer.FilterProcessor {
  constructor(options) {
    super(options);
...
OfftonicAudioplayer.registerProcessor('LinearFilterProcessor', LinearFilterProcessor);