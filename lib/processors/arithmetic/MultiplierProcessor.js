class MultiplierProcessor extends OfftonicAudioplayer.AudioComponentProcessor {
  constructor(options) {
    super(options);
  }
...
OfftonicAudioplayer.registerProcessor('MultiplierProcessor', MultiplierProcessor);