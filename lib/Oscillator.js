...
class Oscillator extends Generator {
  ...
  setOptions(options) {
    ...
    this._initComponent('phasor', options, Oscillator.defaultOptions.phasor);
    this._initProperty('frequency', options);
    this._initProperty('phase', options); // no need for default, since value is already initialized
